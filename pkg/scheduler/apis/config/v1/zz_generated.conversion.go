...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.TestScoreArgs)(nil), (*config.TestScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_TestScoreArgs_To_config_TestScoreArgs(a.(*v1.TestScoreArgs), b.(*config.TestScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.TestScoreArgs)(nil), (*v1.TestScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_TestScoreArgs_To_v1_TestScoreArgs(a.(*config.TestScoreArgs), b.(*v1.TestScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_KubeSchedulerConfiguration_To_config_KubeSchedulerConfiguration(in *v1.KubeSchedulerConfiguration, out *config.KubeSchedulerConfiguration, s conversion.Scope) error {
	...
	out.MetisAddress = in.MetisAddress
	return nil
}
...
func autoConvert_v1_TestScoreArgs_To_config_TestScoreArgs(in *v1.TestScoreArgs, out *config.TestScoreArgs, s conversion.Scope) error {
	out.PrometheusAddress = in.PrometheusAddress
	return nil
}

// Convert_v1_TestScoreArgs_To_config_TestScoreArgs is an autogenerated conversion function.
func Convert_v1_TestScoreArgs_To_config_TestScoreArgs(in *v1.TestScoreArgs, out *config.TestScoreArgs, s conversion.Scope) error {
	return autoConvert_v1_TestScoreArgs_To_config_TestScoreArgs(in, out, s)
}

func autoConvert_config_TestScoreArgs_To_v1_TestScoreArgs(in *config.TestScoreArgs, out *v1.TestScoreArgs, s conversion.Scope) error {
	out.PrometheusAddress = in.PrometheusAddress
	return nil
}

// Convert_config_TestScoreArgs_To_v1_TestScoreArgs is an autogenerated conversion function.
func Convert_config_TestScoreArgs_To_v1_TestScoreArgs(in *config.TestScoreArgs, out *v1.TestScoreArgs, s conversion.Scope) error {
	return autoConvert_config_TestScoreArgs_To_v1_TestScoreArgs(in, out, s)
}
